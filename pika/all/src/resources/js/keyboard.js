...
export class PikaKeyboard extends PikaUserInput {
  ...
  constructor(
    ...
    /** @type {Key} */
    this.powerHitAltKey = new Key(powerHitAlt);
    /** @type {Key} */
  ...
  getInput() {
    ...
    const isDown = this.powerHitKey.isDown || this.powerHitAltKey.isDown;
  ...
  unsubscribe() {
    ...
    this.powerHitAltKey.unsubscribe();
