...
验收，能用一句话说清核心。说不清，说明有多个核，只留一个。挖不动，观点本身就是底，没有文章可写，告诉用户。
...
1. 口语检验，逐段读。你会这样跟朋友说吗？不会就改。最高优先级。连词不是敌人，"但是"、"所以"、"就像"是思维自然转弯的声音，只砍机械连词（"此外"、"另外"、"值得注意的是"），别砍活的。
